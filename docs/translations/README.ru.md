...
>
> Docker Hub показывает сжатый размер загрузки: `latest` примерно 4,0 GiB, `slim` примерно 2,1 GiB. Docker, Synology Container Manager и файловые системы NAS могут показывать больший размер после распаковки слоев.
