...
FFMPEG_BACKPORT_VERSION='7:5.1.9-0+deb12u1+holyclaude2'
...
FFMPEG_RIST_UPSTREAM_COMMIT='8880a174d08131f94f58a0492d1c8c6d68b74f67'
...
FFMPEG_RIST_PATCH_SHA256='e3f65cffd2e3788809d6d6a7771df6eeb85121bdcc85d4f7267f30c4b7a7ed75'
...
test "$FFMPEG_RIST_UPSTREAM_COMMIT" = '8880a174d08131f94f58a0492d1c8c6d68b74f67'
...
printf '%s  %s\n' \
  ...
  "$FFMPEG_RIST_PATCH_SHA256" "$patch_root/CVE-2026-75143.patch" \
...
patch --batch --fuzz=0 --forward -p1 < "$patch_root/CVE-2026-75143.patch"
...
grep -Fqx '    size = FFMIN(data_block->payload_len, size);' libavformat/librist.c
...
ffmpeg (7:5.1.9-0+deb12u1+holyclaude2) bookworm; urgency=medium

  * Backport CVE-2026-70628, CVE-2026-70632, and CVE-2026-75143 fixes.

 -- CoderLuii <coderluii@users.noreply.github.com>  Wed, 02 Sep 2026 00:00:00 +0000
...
SOURCE_DATE_EPOCH='1788307200' DEB_BUILD_OPTIONS='nocheck nodoc' dpkg-buildpackage -b -uc -us
