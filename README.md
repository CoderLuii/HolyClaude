...
In v1.5.8, CloudCLI moves to the verified 1.37.2 baseline and adds the gpt-5.6 model family while preserving HolyClaude's account-management, browser, base-path, notification, and Codex patches. Claude Code tracks stable 2.1.231, Cursor Agent moves to build `2026.08.11-e8db854`, and Debian Chromium moves to 151.0.7922.173. npm stays at 11.19.0 because npm 12 rejects CloudCLI's verified shrinkwrap, and TypeScript stays at 6.0.3 because the 7.0.2 native binary carries fixed-version Go findings.
